...
namespace jns
{
	...
	void Player::Initialize()
	{
		...
		at->CreateAnimations(L"..\\Resources\\Charactor\\CharProne", 100, 0.1f, Vector2(0.0f, 0.25f));
		at->CreateAnimations(L"..\\Resources\\Charactor\\CharProneStab", 100, 0.2f, Vector2(0.0f, 0.25f));
