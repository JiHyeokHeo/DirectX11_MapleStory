...
namespace jns
{
	...
	void SkillManager::Initialize()
	{
		...
		mSkillData[L"Normal_Assain_First_Attack"] = std::make_shared<SkillData>(L"Normal_Assain_First_Attack", 5, 0.5f, 4, eKeyCode::NONE );
		mSkillData[L"Normal_Assain_Second_Attack"] = std::make_shared<SkillData>(L"Normal_Assain_Second_Attack", 5, 1.0f, 4, eKeyCode::NONE);
		mSkillData[L"BloodyMeso"] = std::make_shared<SkillData>(L"BloodyMeso", 1, 1.0f, 1, eKeyCode::NONE);
